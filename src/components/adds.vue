...
export default {
  ...
  methods: {
    submitForm() {
      this.$axios
        .post("http://106.55.103.200:8088/fire_ant_project/admin/addCommonAdmin", {
    ...
    getcode() {
      ...
      this.$axios
        .post(
          "http://106.55.103.200:8088/fire_ant_project/admin/getAdminEmailCode",
          {
            adminEmail: this.ruleForm.pass,
          }
        )
