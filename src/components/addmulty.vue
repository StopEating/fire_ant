...
export default {
  ...
  methods: {
    back() {
      ...
      if (
        ...
        this.$parent.$parent.$options.parent.multy =
          this.$parent.$parent.$options.parent.multy + 1;
    ...
    add() {
      ...
      this.E = $("#editore").find(".w-e-text").text();
  ...
  mounted() {
    ...
    this.$axios
      .post(
        "http://106.55.103.200:8088/fire_ant_project/multipleChoice/addMultipleChoice?question=" +
          ""
      )
      .then((res) => {
