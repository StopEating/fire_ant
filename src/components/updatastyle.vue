...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if (this.form.name !== "" && endTime !== "NaN-NaN-NaN NaN:NaN:NaN") {
        this.$axios
          .post(
            "http://106.55.103.200:8088/fire_ant_project/examStyle/modifyExamStyleByExamId",
            {
              examId: this.examId,
  ...
  mounted() {
    ...
    this.$axios
      .get(
        "http://106.55.103.200:8088/fire_ant_project/examStyle/getThisExamStyleByExamId?examId=" +
          this.examId
      )
      .then((res) => {
        console.log(res);
        this.form.name = res.data.message.examType;
        this.form.examtime = res.data.message.examTime / 60;
        this.form.date1 = res.data.message.endTime;
        this.form.date2 = res.data.message.endTime;
        this.form.single = res.data.message.singleNumber;
        this.form.multiple = res.data.message.multipleNumber;
        this.form.judge = res.data.message.judgeNumber;
        this.form.singlescore = res.data.message.singleScore;
        this.form.judgescore = res.data.message.judgeScore;
        this.form.rule = res.data.message.examRule;
        this.form.examchance = res.data.message.totalExamChance;
      })
      .catch((error) => {
        console.log(error);
      });
